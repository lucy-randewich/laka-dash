...
window.onload = function() {
    ...
    var game = new (0, _game.Game)(canvas);
    game.start();
};

},{"./game":"2OwCD"}],"2OwCD":[function(require,module,exports) {
/*
...
var Game = /** @class */ function() {
    function Game(canvas) {
        ...
        this.obstacleSpeedIncrement = 0.0008;
        this.obstacleSpawnInterval = 1500;
        this.minObstacleSpawnInterval = 1000;
        this.obstacleSpawnIntervalDecrement = 0.6;
    ...
    Game.prototype.gameLoop = function() {
        ...
        this.draw();
        if (this.animationFrameId !== null) this.animationFrameId = requestAnimationFrame(function() {
            return _this.gameLoop();
        });
    };
    Game.prototype.update = function(deltaTime) {
        ...
        if (deltaTime > this.obstacleSpawnInterval) {
            ...
            this.obstacles.push(new (0, _obstacle.Obstacle)(this.canvas.width, this.canvas.height, obstacleSpeed));
            this.lastObstacleSpawnTime = Date.now();
        }
        ...
        this.obstacles.forEach(function(obstacle) {
            if (_this.cyclist.collidesWith(obstacle)) _this.gameOver();
        });
        // Increment score
        this.score += 1;
...
},{"./cyclist":"9b8gj","./obstacle":"1IZjq","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9b8gj":[function(require,module,exports) {
/*
...
},{}],"1IZjq":[function(require,module,exports) {
/*
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["aLsy6","7elyk"], "7elyk", "parcelRequire86a7")
